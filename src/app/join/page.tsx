          ...
          <CardContent className="p-12 space-y-10">
            <div className="space-y-4 text-center">
              <Input 
                ...
                placeholder="000000"
                maxLength={6}
                className="text-7xl font-black text-center h-32 border-none bg-transparent focus-visible:ring-0 uppercase tracking-tighter placeholder:opacity-10 text-primary shadow-none"
              />
            </div>
