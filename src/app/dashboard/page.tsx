      ...
      <main className="flex-1 max-w-[1400px] mx-auto w-full px-6 py-32 space-y-10">
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <Button 
            ...
            className="h-16 px-10 rounded-[1.5rem] text-sm font-black bg-primary text-primary-foreground border-2 border-primary hover:bg-transparent hover:text-primary transition-all uppercase tracking-widest shrink-0"
          >
