      ...
      <main className="flex-grow pt-32">
            ...
            <div className="space-y-12">
              ...
              <div className="flex gap-6 items-center p-8 bg-foreground/5 rounded-[1.5rem] border-2 border-foreground/10">
                ...
                <div>
                  ...
                  <p className="font-bold opacity-40 uppercase text-xs tracking-widest">Total Participation Protocol</p>
                </div>
              </div>
            </div>
        ...
        <section className="py-60 px-6 text-center bg-foreground text-background">
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            <p className="text-sm font-black uppercase tracking-[0.4em] opacity-40 pt-12">Zero Friction. Instant Sync. Built for the bold.</p>
          </div>
        </section>
      </main>
